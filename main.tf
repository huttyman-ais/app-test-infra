...
module "acr" {
  source              = "git::https://github.com/huttyman-ais/idp-poc-backstage.git//terraform-modules/acr?ref=main"
  name                = local.acr_name
...
module "keyvault" {
  source              = "git::https://github.com/huttyman-ais/idp-poc-backstage.git//terraform-modules/keyvault?ref=main"
...
module "postgresql" {
  source              = "git::https://github.com/huttyman-ais/idp-poc-backstage.git//terraform-modules/postgresql?ref=main"
...
module "container_apps" {
  source              = "git::https://github.com/huttyman-ais/idp-poc-backstage.git//terraform-modules/container-apps?ref=main"
